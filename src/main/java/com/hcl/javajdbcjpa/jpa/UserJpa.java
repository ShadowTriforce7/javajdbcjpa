			...
			try (Scanner input = new Scanner(System.in);) {
				...
				while (menu) {
					...
					case "delete":
						...
						Query del = entityManager.createQuery("delete from Use s where s.ID=?");
					...
					case "read":
						...
						Query read = entityManager.createQuery("select s from Use s where s.ID=?");
						...
						break;
					case "readall":
						Query readAll = entityManager.createQuery("select s from Use s");
